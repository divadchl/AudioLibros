...
public class Libro {
    ...
    public final static String[] G_ARRAY = new String[]{G_TODOS,
    ...
    public static Vector<Libro> ejemploLibros(){
        ...
        libros.add(new Libro("Avecilla", "Alas Clarín, Leopoldo", R.drawable.ovecila, SERVIDOR+"avecilla.mp3",
        ...
        libros.add(new Libro("Viejo Pancho, El", "Alonso y Trelles, Dosé", R.drawable.viejo_pancho, SERVIDOR+"viejo_pancho.mp3",
